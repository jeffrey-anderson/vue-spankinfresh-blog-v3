  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
      <router-link class="navbar-brand" :to="{ name: 'home' }">
        <img style="max-width: 55px" src="../assets/sf-logo-50h.png"
             alt="SpankinFresh Farmers Market Logo"/>
        SpankinFresh
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <router-link class="nav-link" :to="{ name: 'home' }"><i class="fas fa-home"></i> Home
              <span class="sr-only">(current)</span></router-link>
          </li>

          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'toc' }"><i class="fas fa-list"></i> All
              Articles
            </router-link>
          </li>
